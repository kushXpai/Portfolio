    ...
    {items.map((item, idx) => (
      <div
        ...
        <Image
          ...
          src={item.image}
          alt={item.name}
          className="object-cover !m-0 !p-0 object-top rounded-full h-10 w-10 border group-hover:scale-105 group-hover:z-30 border-black relative transition duration-500" 
          />
      </div>
    ))}
  </>);
